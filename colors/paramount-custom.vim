" Name:       paramount-custom.vim
" Version:    0.1.0
" Maintainer: David Johnston
" License:    The MIT License (MIT)
"
" A minimal colorscheme for Vim that only puts emphasis on the paramount.
"
" Forked from the paramount theme
"
...
let g:colors_name='paramount-custom'
...
let s:pink            = { "gui": "#fb007a", "cterm": "13"  }
let s:dark_red        = { "gui": "#C30771", "cterm": "1"   }
let s:light_red       = { "gui": "#FF0000", "cterm": "9"   }
let s:orange          = { "gui": "#D75F5F", "cterm": "167" }
let s:dark_gray_blue  = { "gui": "#090D0F", "cterm": "0"   }
...
call s:h("Comment",       {"fg": s:yellow, "gui": "italic"})
...
call s:h("StringLiteral", {"fg": s:purple})
hi! link Character        StringLiteral
hi! link String           StringLiteral
...
call s:h("User1",  {"bg": s:norm_subtle})
